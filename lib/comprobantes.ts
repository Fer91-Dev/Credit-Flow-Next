...
export const SERIE_LABEL = {
  ...
  CIE: "Retiro de cierre de turno",
  ACT: "Acta de cierre de turno",
   ...
   * normal — es plata que se creía irrecuperable, y en el libro tiene que poder distinguirse.
   */
  RCP: "Recupero de incobrable",
} as const;
