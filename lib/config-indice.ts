...
export const PARAMETROS: ParametroIndexado[] = [
  ...
  { label: "Acuerdos rotos antes de tener que refinanciar", tab: "cobranza", seccion: "Acuerdos de pago" },
  ...
  { label: "Honorarios máximos (%)", tab: "cobranza", seccion: "Refinanciaciones" },
